<div class="container text-center">
	<div class="row">
		<div class="col text-center">
			...
			<div class="row">
				<div class="popup Nshows" id="add" onclick="popItUp('."'add'".')"></div>
				<div class="col col-xs-8 offset-xs-2 myPopup Nshows add" id="add">
					<h3>add event</h3>
					<br>
					<form action="evenementen\addEvent" method="post">
						<div class="input-field row">
							<div class="col col-xs-8 offset-xs-1 col-md-6 offset-md-2">
				...
				<div class="popup Nshows" id="edit" onclick="popItUp('."'edit'".')"></div>
				...
				<div class="popup Nshows" id="remove" onclick="popItUp('."'remove'".')"></div>
			...
			<div class="row">
				...
				<br>
				<p>Facebook Heeft een domein nodig om de events uit te lezen...</p>
