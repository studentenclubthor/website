				...
				CHILD: function(e, t, n, i, r) {
					...
					return 1 === i && 0 === r ? function(e) {
						...
						if (g) {
							...
							} else if (y && (f = t, d = f[W] || (f[W] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], h = c[0] === V && c[1], b = h), b === !1)
								for (;
...
$(window).scroll(function() {
	...
	function(e, t) {
		...
		return u.init = function(e) {
			...
			for (var n, i, o = 0, a = e.length; o < a; o++) n = e[o], i = n.tagName.toLowerCase(), ["input", "img"].indexOf(i) !== -1 && (m[i](n), n = n.parentElement), n.className.indexOf("waves-effect") === -1 && (n.className += "" + t)
